...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        //create table query
        String CREATE_TABLE="create table "+TABLE_NAME_USER+"(" +COL_ID+ "'INTEGER PRIMARY KEY AUTOINCREMENT',"+COL_USER_NAME+"'TEXT',"+COL_EMAIL+"'TEXT',"+COL_PASSWORD+"'TEXT',"+COL_PHONE+"'TEXT')";
        //execute query
